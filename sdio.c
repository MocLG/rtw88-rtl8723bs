					   ...
					   size_t write_size, int ret)
{
	...
	rtw_info(rtwdev,
		 ...
		 rtw_read16(rtwdev, 0x21c),
			 ...
			 rtw_read16(rtwdev, REG_SYS_FUNC_EN),
			 rtw_read16(rtwdev, REG_SYS_CLKR),
			 rtw_read8(rtwdev, REG_APSD_CTRL),
			 rtw_read8(rtwdev, REG_RF_CTRL),
			 rtw_read32(rtwdev, REG_RSV_CTRL),
			 rtw_read32(rtwdev, REG_AFE_CTRL1),
